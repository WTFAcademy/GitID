...
function Stats() {
    ...
    return (
        <div className="w-[326px] h-auto rounded-sm border border-solid border-[#A5B4FC] border-opacity-[48]">
            <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                    <ul className="flex-col w-[70%]">
                        {stats.map((stat, index)=>(
                            <li className="flex my-[6px] font-bold text-xs leading-none text-[#1F2937]">
